        ...
        <div class="card-body">
          <form action="" method="post" class="form-horizontal">
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                <div class="form-group">
                  <label for="" style="margin-top: 0.8em;"><br><br></label>
                  <button class="btn btn-primary" name="btnCheck">CHECK AVAILABILITY</button>
                </div>
              </div>
            </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" style="width: 100%;" name="assessor_id">
                    ...
                    while ($rwi2 = $rsi2->fetch_assoc()){
                      // check availability
                      $ada = checkAvailability($conn, $rwi2['id'], $bookDate, $bookTime);

                      if ($ada == 0){
                      ?>
                      <option value="<?=$rwi2['id'];?>"><?=getSalutation($conn, $rwi2['salutation_id']) . ' ' . ucwords($rwi2['fullname']) . '-' . $ada;?></option>
                    <?php }} ?>
                  </select>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <button type="submit" class="btn btn-success" name="submitRequest">SEND REQUEST</button>
                <button type="reset" class="btn btn-secondary">RESET REQUEST</button>
              </div>
            </div>
            <?php } // close check availability?>
          </form>
        </div>
        <!-- /.card-body -->
