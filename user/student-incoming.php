    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Incoming session</h3>
        ...
        <div class="card-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <?php
              $sqi1 = "select *
                       from assessments
                       where user_id = '" . $_SESSION['user_id'] . "' and request_status = '1' and feedback_id = '0'";
              $rsi1 = $conn->query($sqi1);
            ...
            <tr>
              ...
              <td style="width: 150px;">
                ...
                <?php } else { ?>
                  ...
                  <?php
                    if ($rwi1['patient_id'] == 0){
                  ?>
                      <a href="?n=3&id=<?=$rwi1['id'];?>">Please select patient</a>
                  <?php    
                    }
                  ?>
                <?php } ?>
...
<!--        </div>-->
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Please select patient</h3>
              ...
              <tr>
                ...
                <td style="width: 150px;">
                  ...
                  <?php } else { ?>
                    ...
                    if ($rwi1['patient_id'] == 0){
                      ?>
                      <a href="?n=3">Please select patient</a>
                      <?php
                    }
                    ?>
                  <?php } ?>
